<template>
  <el-card>
    <h1 class="me-author-name">DoReMi 博客网站</h1>
    <div class="me-author-description">
      <span><i class="el-icon-location-outline"></i> &nbsp;浙江&杭州</span>
      <span><i class="me-icon-job"></i> &nbsp;java入门小学生</span>
    </div>
...
<script>
  export default {
    ...
    data() {
      return {
        qq: {title: 'QQ', message: '1375460391'},
        bilibili: {
          title: '哔哩哔哩',
          message: '<a target="_blank" href="https://space.bilibili.com/403587718">https://space.bilibili.com/403587718</a>'
        }
      }
    },
    methods: {
